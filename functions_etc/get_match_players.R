...
plot_pitch(lineColor = shUEFA["blueLt"]) + shUEFA_theme + 
  ...
  annotate("text", x = position_column_1, y = position_row_3, color = shUEFA["orange"], label = "1 GK\nPlayer Name") + 
  
  annotate("text", x = position_column_2, y = position_row_1, color = shUEFA["orange"], label = "2 RB\nPlayer Name") + 
  annotate("text", x = position_column_2, y = position_row_2, color = shUEFA["orange"], label = "3 RCB\nPlayer Name") + 
  annotate("text", x = position_column_2, y = position_row_3, color = shUEFA["orange"], label = "4 CB\nPlayer Name") + 
  annotate("text", x = position_column_2, y = position_row_4, color = shUEFA["orange"], label = "5 LCB\nPlayer Name") + 
  annotate("text", x = position_column_2, y = position_row_5, color = shUEFA["orange"], label = "6 LB\nPlayer Name") + 
  
  annotate("text", x = position_column_3, y = position_row_1, color = shUEFA["orange"], label = "7 RWB\nPlayer Name") + 
  annotate("text", x = position_column_3, y = position_row_2, color = shUEFA["orange"], label = "8 LWB\nPlayer Name") + 
  annotate("text", x = position_column_3, y = position_row_3, color = shUEFA["orange"], label = "9 RDM\nPlayer Name") + 
  annotate("text", x = position_column_3, y = position_row_4, color = shUEFA["orange"], label = "10 CDM\nPlayer Name") + 
  annotate("text", x = position_column_3, y = position_row_5, color = shUEFA["orange"], label = "11 LDM\nPlayer Name") + 
  
  annotate("text", x = position_column_4, y = position_row_1, color = shUEFA["orange"], label = "12 RM\nPlayer Name") + 
  annotate("text", x = position_column_4, y = position_row_2, color = shUEFA["orange"], label = "13 RCM\nPlayer Name") + 
  annotate("text", x = position_column_4, y = position_row_4, color = shUEFA["orange"], label = "15 LCM\nPlayer Name") + 
  annotate("text", x = position_column_4, y = position_row_5, color = shUEFA["orange"], label = "16 LM\nPlayer Name") + 
  
  annotate("text", x = position_column_5, y = position_row_1, color = shUEFA["orange"], label = "17 RW\nPlayer Name") + 
  annotate("text", x = position_column_5, y = position_row_2, color = shUEFA["orange"], label = "18 RAM\nPlayer Name") + 
  annotate("text", x = position_column_5, y = position_row_3, color = shUEFA["orange"], label = "19 CAM\nPlayer Name") + 
  annotate("text", x = position_column_5, y = position_row_4, color = shUEFA["orange"], label = "20 LAM\nPlayer Name") + 
  annotate("text", x = position_column_5, y = position_row_5, color = shUEFA["orange"], label = "21 LW\nPlayer Name") + 
  
  annotate("text", x = position_column_6, y = position_row_2, color = shUEFA["orange"], label = "22 RCF\nPlayer Name") + 
  annotate("text", x = position_column_6, y = position_row_3, color = shUEFA["orange"], label = "23 CF\nPlayer Name") + 
  annotate("text", x = position_column_6, y = position_row_4, color = shUEFA["orange"], label = "24 LCF\nPlayer Name")
